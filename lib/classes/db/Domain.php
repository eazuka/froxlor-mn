...
class Domain extends ModelBase
{
     ...
     * @var integer
     *
     * @ORM\Column(name="ipandport", type="integer", nullable=false)
     */
	public $ipandport = '1';
     ...
     * @var boolean
     *
     * @ORM\Column(name="ssl_ipandport", type="boolean", nullable=false)
     */
	public $sslIpandport = '0';
     ...
     * @var integer
     *
     * @ORM\Column(name="ismainbutsubto", type="integer", nullable=false)
     */
	public $ismainbutsubto = '0';
