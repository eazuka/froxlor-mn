...
$lng['admin']['nodes']['default']['title'] = 'Default Node';
$lng['admin']['nodes']['default']['description'] = 'Default nodes will generate config for all domains which are not explicitely assigned to a node';
$lng['admin']['nodes']['domains'] = 'Domains';
$lng['admin']['nodes']['domain_multi']['title'] = 'Domains';
